...
public class PhrasePicker {
    ...
    /**
     * Ritorna la prima frase disponibile per la tipologia di stack passata per
     * parametro.
     *
     ...
     */
    private String getFirstStringOfList(Stack<String> lista, Object... po) {
    ...
    public String getGenerationString(Player p) {
        return getFirstStringOfList(lista_generazione, p);
    }

    /**
     * Ritorna la frase per il round, sostituendo il nome del giocatore
     * danneggiato e il valore del danno.
     *
